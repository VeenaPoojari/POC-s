	...
	public static void main(String[] args) {
		...
		if (args.length < 1) {
			System.err.println("Usage: java "
					+ printReport.getClass().getName() + " PDF_Filename");
			System.exit(1);
		}
	...
	private void createPDF(String pdfFilename) {
		...
		try {
			...
			for (int x = 1; x < 5; x++) {
				...
				insertCell(table, "This is Customer Number ABC00" + x,
			...
			insertCell(table, "New York Total...", Element.ALIGN_RIGHT, 3,
					bfBold12);
			insertCell(table, df.format(total), Element.ALIGN_RIGHT, 1,
					bfBold12);
			...
			insertCell(table, "California Total...", Element.ALIGN_RIGHT, 3,
					bfBold12);
			insertCell(table, df.format(total), Element.ALIGN_RIGHT, 1,
					bfBold12);
